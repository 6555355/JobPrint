...
//
//static char auchCRCLo[1];
//static unsigned char auchCRCHi[1];

const unsigned char crc8_1Wire_table[]=
{   //X8+X5+X4+1 ¶àÏîÊ½. CRC-8-Dallas/Maxim. for 1-Wire Bus.
...
const unsigned char crc8_CCITT_table[]=
{  // X^8 + X^2 + X^1 + 1, CRC-8-CCITT.
